...
De tabellen zijn nu ingeladen in dbever. De volgende stap is om de inhoud van de tabellen in dbever te inspecteren aan de hand van SQL. De code in ce chunk hieronder is niet gerund, deze is in dbeaver gerund. het gevormde sql file is te vinden in mijn [Github]() repository. 
